        ...
        <section>
            ...
            <article className="h-[20vh] border-3 border-[#FED2E2]  bg-[#8F87F1] flex justify-evenly items-center">
                ...
                <div className=' flex w-full h-full relative'>
                    <img style={{ backgroundImage:`url("src/Components/assets/i1.jpeg")`,height:"100%", backgroundSize:"cover",backgroundPosition:"center",Width:"100%",backgroundRepeat:"no-repeat",}} src={i1} className='w-full h-full relative'/>
