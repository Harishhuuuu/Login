  ...
  return (
    <section>
        ...
        <section>
            ...
            <img style={{ backgroundImage:`url("src/Components/assets/f5.jpeg")`,height:"100%", backgroundSize:"cover",backgroundPosition:"center",Width:"100%",backgroundRepeat:"no-repeat",}} src={f5} className='w-full h-full relative'/>
